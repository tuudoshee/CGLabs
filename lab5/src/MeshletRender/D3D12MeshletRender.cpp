...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\head3.bin";
const wchar_t* c_texturePath = L"..\\Assets\\texture.jpeg";
...
void D3D12MeshletRender::OnUpdate()
{
    ...
    XMMATRIX world = XMMatrixScaling(30, 30, 30)* XMMatrixTranslation(0.0f, 50.0f, 50.0f);
